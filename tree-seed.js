/* Cây gia phả – cấu trúc phân nhánh theo sơ đồ tay */
window.GIA_TREE_SEED = function(data, saveTree) {
  ...
  mk('lach', { name: 'Nguyễn Văn Lạch', generation: 5, birthDate: '1912', deathAnniversary: '26/12', branchLabel: 'Nhánh Lạch', notes: 'Đời 5 · Cụ 5 đời · Giỗ 26/12' });
  mk('ngoc', { name: 'Nguyễn Văn Ngọc', generation: 5, birthDate: '1914', deathAnniversary: '15/1', branchLabel: 'Nhánh Ngọc', notes: 'Đời 5 · Giỗ 15/1' });
  link('root', 'coc');
  link('root', 'lach');
  link('root', 'ngoc');
  ...
  mk('tutai', { name: 'Từ Thái', gender: 'female', generation: 4, notes: 'Đời 4 · Vợ Cụ Lạch' });
  ...
  mk('lang',  { name: 'Nguyễn Văn Láng',  generation: 4, deathAnniversary: '24/4', notes: 'Đời 4 · Giỗ 24/4' });
  link('lach', 'giang');
  link('lach', 'lang');

  mk('nghiec', { name: 'Nguyễn Văn Nghĩa', generation: 4, notes: 'Đời 4 · Còn gọi Nghềc' });
  mk('the',    { name: 'Nguyễn Văn The',   generation: 4, deathAnniversary: '8/8', notes: 'Đời 4 · Giỗ 8/8 · Còn gọi Thu' });
  link('ngoc', 'nghiec');
  link('ngoc', 'the');
  ...
  mk('nhan', { name: 'Nguyễn Văn Nhẫn', generation: 3, deathAnniversary: '30/1', notes: 'Đời 3 · Giỗ 30/1' });
  ...
  mk('nu',   { name: 'Nguyễn Nữ',  gender: 'female', generation: 2, notes: 'Đời 2' });
  ['thue','nha','thuy','tam','nhom','tam2','nu'].forEach(id => link('nhan', id));

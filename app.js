...
function renderTree(){
  ...
  if(!hint){
    ...
    hint.textContent='📜 Đời 1 = Cụ Tổ Mương → Đời 6 = nay · Vuốt ngang · Bấm ▲/▼ · Bấm tên để sửa';
